...
Data cleaning, data analysis and paper itself was conducting using R Markdown in R Studio. Graphs were generated using ggplot2 package. Panel regressions were performed using the plm package. Tables and graphs were generated using the stargazer package. Data Manipulation was done using dplyr.

## Data Analysis and Presentation Packages

\noindent [1] Achim Zeileis. 2004. "Econometric Computing with HC and HAC Covariance Matrix Estimators." Journal of Statistical Software, 11(10), 1-17. URL http://www.jstatsoft.org/v11/i10/.

\noindent [2] Croissant, Yves, and Giovanni Millo. 2008. "Panel Data Econometrics in R: The plm Package." Journal of Statistical Software, 27(2). URL http://www.jstatsoft.org/v27/i02/.
