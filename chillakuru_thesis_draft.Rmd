 ...
 * Subset data for migration of individuals.
 * Regression for each individual disease
 * Look at Literature for treatment location
 * Look at roads impact on days incapacitated
...
```{r anyDiseaseOut, fig.width=3, echo=FALSE, results='asis'}
stargazer(plm.1, plm.2, plm.3, se=list(r.se.1, r.se.2, r.se.3), title="Road Paved and Incidence of Any Disease: OLS with Village and Time-Fixed Effects", header=FALSE)
...
```{r comDiseaseOut, fig.width=3, echo=FALSE, results='asis'}
stargazer(plm.7, plm.8, plm.9, se=list(r.se.7, r.se.8, r.se.9), title="Road Paved and Incidence of Communicable Disease: OLS with Village and Time-Fixed Effects", header=FALSE)
...
```{r nonComDiseaseOut, fig.width=3, echo=FALSE, results='asis'}
stargazer(plm.13, plm.14, plm.15, se=list(r.se.13, r.se.14, r.se.15), title="Road Paved and Incidence of Non-Communicable Disease: OLS with Village and Time-Fixed Effects", header=FALSE)
...
```{r STDorAIDSOut, fig.width=3, echo=FALSE, results='asis'}
stargazer(plm.19, plm.20, plm.21, se=list(r.se.19, r.se.20, r.se.21), title="Road Paved and Incidence of STD/AIDS: OLS with Village and Time-Fixed Effects", header=FALSE)
