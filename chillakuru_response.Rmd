...
# Requests from Professor Sinclair
  ...
  * Professor requested to use the smallest sample for all analysis as certain controls lowered the sample size during regression analysis. This was addressed by dropping all observations with missing values for all regressor terms. This dropped the sample size from 2800 observations to 2585 obersvations (`r round(100*(2800-2585)/2800,2)`% drop in sample size).
