...
## Results
  ...
  * As suggested by referee, a more thorourgh discussion of Adjusted R^2 was included in the results section.
  * Referee suggested rewording "percentage point increase" increase to "point increase in percent" stating that I was not performing a logit/probit analysis. However, "percentage point increase" and "point increase in percent" are referring to the same thing. "Percent increase" would be the appropriate terminology for a logit/probit model: <https://www.reed.edu/academic_support/pdfs/qskills/percent.pdf>.
