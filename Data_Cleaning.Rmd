...
# 5. Transfor distanceToPavedRoad to ln(1+distanceToPavedRoad)
df2005$lnDistanceToPavedRoad <- log(1 + df2005$distanceToPavedRoad)
df2012$lnDistanceToPavedRoad <- log(1 + df2012$distanceToPavedRoad)
```
...
# 8. Merge Dataframes to main dataset
...
# TO FIX:
 * Convert mbTreatmentWho1,2 and mbTreatmentWhere1,2 to percentage
 * Convert castes to percentages
 * Convert drinkingWater to percentages
